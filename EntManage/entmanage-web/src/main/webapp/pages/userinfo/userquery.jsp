			...
			<div class="col-sm-12">
				<div class="row">
					...
					<div class="form-group col-sm-3">
						<label>用户账号</label>
						<input type="text" class="form-control" id="userid_params"  placeholder="用户账号">
					</div>
	...
	<script>
		...
		function initSysUsersData(){
            var userList= $('#sysUserList').dataTable({
				"sAjaxSource" : path+"/userinfo/query.htm",
		        ...
		        aoColumns:[
					...
					{mData:'userid',"sWidth":"100px"},
					{mData:'username',"sWidth":"100px"},
					{mData:'password',"sWidth":"100px"},
		...
		function editSysUser(type){
			if('add'==type){ // 新增
				...
				$.yf.openWin("#newSysUserWin",'/userinfo/edit.htm',{'id':$user_id});
